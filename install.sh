...
running "Enable Notification Center and remove the menu bar icon"
launchctl load -w /System/Library/LaunchAgents/com.apple.notificationcenterui.plist > /dev/null 2>&1;ok
